                    ...
                    <table class="table table-bmedicaled table-hover">
                        ...
                        @foreach($medicals as $medical)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('historia.medica', $medical) }}" data-toggle="tooltip" data-placement="top" title="HISTORIA"><i class="fas fa-notes-medical text-info fa-lg btn btn-outline-info"></i></a>
                                </td>
                                <td class="text-center">
